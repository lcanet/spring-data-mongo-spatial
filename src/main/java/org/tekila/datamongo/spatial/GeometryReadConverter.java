 ...
 */
@ReadingConverter
public enum GeometryReadConverter implements Converter<BasicDBObject, Geometry>  {
  INSTANCE;

  private GeometryFactory geometryFactory = new GeometryFactory(new PrecisionModel(), 4326);

  @SuppressWarnings({ "unchecked", "rawtypes" })
  public Geometry convert(BasicDBObject dbo) {

    String type = dbo.getString("type");
    List coordinates = (List) dbo.get("coordinates");
